...
public class VidyoSampleApplication extends android.app.Application {
	...
	private static VidyoSampleActivity mActivity;
	...
	*/
	...
	public boolean initialize(String caFileName, String uniqueId, Activity activity) {
		String pathDir;
		mActivity = (VidyoSampleActivity)activity;
		try {
...
//			logDir = getAndroidSDcardMemDir();
	...
	public void vidyoConferenceFrameReceivedCallback(int participantId, int width, int height, byte[] rawImageBytes)
	{
		Log.d(TAG, "Frame received");
		mActivity.vidyoConferenceFrameReceivedCallback(participantId, width, height, rawImageBytes);
	}
	...
	public native void ConferenceEnd();
	...
	public native void RefreshWatchList(int maxWatch);
