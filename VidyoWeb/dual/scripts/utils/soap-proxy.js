...
var soapClient = (function () {
     ...
     * @return {jQuery.Deferred object}     Deferred object that can accept .done and .fail functions
     */
        ...
        return $.ajax({
            ...
            .done(function (result) {
                if (result.success === false) {
                    deferredParam.reject(result.message, result.errors);
                    if (onFailure !== undefined) {
                        onFailure.call(self, result.message, result.errors);
                    }
                } else {
                    deferredParam.resolve(result.response);
                    if (onSuccess) {
            ...
            .fail(function (result) {
                ...
                deferredParam.reject("AJAX failure", result.statusText);
                if (onFailure !== undefined) {
    ...
    var request = function (config) {
        ...
        var request = _postSoapRequest(
            ...
            opt.ajaxDataType,
            deferredParam);
        var promise = deferredParam.promise();
