...
import static com.vidyo.vidyosample.VidyoSampleActivity.MUTE_CAMERA;
import static com.vidyo.vidyosample.VidyoSampleActivity.MUTE_MIC;
import static com.vidyo.vidyosample.VidyoSampleActivity.UNMUTE_CAMERA;
import static com.vidyo.vidyosample.VidyoSampleActivity.UNMUTE_MIC;
...
//			logDir = getAndroidSDcardMemDir();
	...
	public void muteCallback(int muteType, boolean mutevalue) {
		int msgType = -1;
		if(muteType == 0)
		{
			if(mutevalue)
				msgType = VidyoSampleActivity.MUTE_CAMERA;
			else
				msgType = VidyoSampleActivity.UNMUTE_CAMERA;
		}
		else if(muteType == 1)
		{
			if(mutevalue)
				msgType = VidyoSampleActivity.MUTE_MIC;
			else
				msgType = VidyoSampleActivity.UNMUTE_MIC;
		}
		Message msg = Message.obtain();
		msg.setTarget(hdlr);
		msg.what = msgType;
	...
	public native void ToolbarAction(int action, boolean muteType);
