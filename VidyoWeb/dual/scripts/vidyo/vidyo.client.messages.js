...
const vidyoClientMessages = (function (vidyoClientParameters) {
		/**
	...
	var vidyoClientMessages = {
		...
		/**
		  * Creates a VidyoClient set portal address request object.
		  * Request used to set portal address.
		  *
		  * The passed in parameter object can store the following
		  * properties:<br/>
		  *  - portalAddress<br/>
		  *
		  * @name vidyoClientMessages.requestSetPortalAddress
		  * @function
		  * @param {Object} params Reference to parameter object.
		  * @return {Object} Reference to created object.
		  */
		'requestSetPortalAddress': function (params) {
			// object created by this factory function
			var that = this.request("RequestSetPortalAddress");
