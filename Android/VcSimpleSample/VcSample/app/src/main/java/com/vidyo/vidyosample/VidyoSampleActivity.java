...
//	  app = new VidyoSampleApplication(message_handler);
    ...
    protected Dialog onCreateDialog(int id) {
        if (id == DIALOG_LOGIN) {
            String guestLoginArray[] = {"dev20.vidyo.com", "guest", "F9bn85Eu68ae"};
            ...
            String portalInfoArray[] = {"sandbox.vidyocloudstaging.com", "tmelko", "Ajtgjmdp1 2"};
            ...
            login_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    usernameString = new StringBuffer(username.getEditableText().toString());
                    passwordString = new StringBuffer(password.getEditableText().toString());
                    ...
                    String name = usernameString.toString();
                    String pass = passwordString.toString();

                    Log.e(TAG, "!!!!!!!!: " + name + " ___  " + pass);

                    app.Login(portal, name, pass);
