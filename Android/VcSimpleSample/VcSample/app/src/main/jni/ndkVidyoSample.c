...
JNIEXPORT jboolean Java_com_vidyo_vidyosample_VidyoSampleApplication_Construct(JNIEnv* env, jobject javaThis,
	...
	//const char *logLevelsAndCategories = "fatal error warning debug@App info@AppEmcpClient debug@LmiApp debug@AppGui info@AppGui all@AppVcsoapClient";
...
//    logParam.pathToDumpDir = "/data/data/com.vidyo.vidyosample/files/";
    ...
    char test[]="fatal error warning debug@App info@AppEmcpClient debug@LmiApp debug@AppGui info@AppGui debug@LmiUi all@AppVcsoapClient";
