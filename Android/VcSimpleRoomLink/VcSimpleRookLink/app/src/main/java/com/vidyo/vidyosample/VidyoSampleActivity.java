...
//	  app = new VidyoSampleApplication(message_handler);
    ...
    protected void ReadCredentials() {
        ...
        serverString = new StringBuffer(settings.getString("ServerString", "https://sandbox.vidyocloudstaging.com"));
        keyString = new StringBuffer(settings.getString("KeyString", "CsUV4kkpdy"));
