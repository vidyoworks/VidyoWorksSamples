...
//			logDir = getAndroidSDcardMemDir();
	...
	public void OnPortalAvailable(boolean value) {

		Log.d(TAG, "OnPortalAvailable!");
		Message msg = Message.obtain();
		msg.obj = name;
		msg.setTarget(hdlr);
		if(value == true)
			msg.what = VidyoSampleActivity.PORTAL_AVAIL;
		else
			msg.what = VidyoSampleActivity.PORTAL_UNAVAIL;
		msg.sendToTarget();
	}
    ...
    public native void IsPortalAccessible(String portal);
