...
namespace UnifiedDotNetSample
{
    public partial class RoomLink : Form
    {
        ...
        public Boolean m_bMuteCamera;
        public Boolean m_bMuteMic;
        public Boolean m_bMuteSpeaker;
        ...
        private void buttonJoin_Click(object sender, EventArgs e)
        {
            ...
            m_bMuteCamera = checkBoxCameraMute.Checked;
            m_bMuteMic = checkBoxMicMute.Checked;
            m_bMuteSpeaker = checkBoxSpeakerMute.Checked;
            this.Close();
        }
    }
}
